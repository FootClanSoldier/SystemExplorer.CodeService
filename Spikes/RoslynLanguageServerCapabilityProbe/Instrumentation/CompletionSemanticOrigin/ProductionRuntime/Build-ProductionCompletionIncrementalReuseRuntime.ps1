...
function Show-Usage {
    Write-Host 'Usage:'
    Write-Host '  Build-ProductionCompletionIncrementalReuseRuntime.cmd -RoslynRepositoryRoot <path> -CurrentServiceThirdPartyZip <path> -CompletionIncrementalReusePatch <path> [-WorkRoot <path>] [-OutputRoot <path>] [-KeepArtifacts]'
    Write-Host ''
